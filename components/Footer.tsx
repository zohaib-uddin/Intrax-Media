        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-24 mb-20">
          ...
          <div className="space-y-8">
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/faizanaliforex " target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 group shadow-sm border-2 border-black hover:border-brand-500 hover:bg-brand-500 bg-transparent">
                <Instagram size={18} className="text-black group-hover:text-black transition-colors" />
              </a>
              <a href="https://www.linkedin.com/in/faizanalifx/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 group shadow-sm border-2 border-black hover:border-brand-500 hover:bg-brand-500 bg-transparent">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-600 font-bold">
              ...
              <li>
                <Link to="/about/why-intrax" className="hover:text-brand-500 transition-colors inline-flex items-center group">
                  <ArrowRight size={14} className="mr-2 text-brand-500 group-hover:translate-x-1 transition-transform" />
                  Why Choose Us
                </Link>
              </li>
