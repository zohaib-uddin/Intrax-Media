        ...
        {portfolioItems.map((item, index) => (
          <FadeInSection key={index} delay={index * 100}>
            <div 
              ...
              className="flex flex-col lg:flex-row gap-16 items-center border-b border-gray-100 pb-20 last:border-0 last:pb-0 scroll-mt-32"
            >
              {/* Content Side */}
              <div className="lg:w-1/2 order-1">
                ...
                <Link to={`/portfolio-detail/${item.name}`}>
