export const PORTFOLIO_BRANDS = [
  ...
  {
    name: "Sweetapolita",
    description: "Self Expression & Special Items",
    stats: [
  ...
  },
  {
    ...
    stats: [
      { value: "85%", label: "Increase In Revenue" },
      { value: "70%", label: "Increase In Ad Revenue" },
      { value: "85%", label: "Increase In Unit Sales" },
      { value: "80%", label: "Increase In Orders" },
    ],
    images: [
